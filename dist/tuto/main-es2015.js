...
let ApiService = class ApiService {
    ...
    postTuto(_id, titre, texte, image) {
    ...
    updateTuto(titre, id, texte, image) {
        const obj = {
            titre, texte, image
        };
...
let LoginComponent = class LoginComponent {
    ...
    onFormSubmit(form) {
        ...
        this.auth.login(username, password).subscribe(result => this.router.navigate(['tutos']));
    }
    submit() {
        const username = this.loginForm.value["username"];
        const password = this.loginForm.value["password"];
...
let TutosDetailComponent = class TutosDetailComponent {
    constructor(renderer, el, route, router, apiService, formBuilder) {
...
TutosDetailComponent.ctorParameters = () => [
...
let TutosComponent = class TutosComponent {
    constructor(route, router, apiService, formBuilder) {
        this.route = route;
        this.router = router;
        this.apiService = apiService;
        this.formBuilder = formBuilder;
    ...
    getTutos() {
        this.apiService.getTutos().subscribe((response) => {
...
let UserListComponentComponent = class UserListComponentComponent {
    constructor() { }
    ngOnInit() {
    }
};
