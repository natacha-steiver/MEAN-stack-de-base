  ...
  export class TutosDetailComponent implements OnInit {
    ...
    update(img,titreInput,texteInput){
      
      const id = this.route.snapshot.paramMap.get('id');
      const titre = this.tutoForm.value["titre"]!=titreInput && this.tutoForm.value["titre"]!=null && this.tutoForm.value["titre"]!="" ?this.tutoForm.value["titre"]:titreInput;
      const texte = this.tutoForm.value["texte"]!=texteInput && this.tutoForm.value["texte"]!=null && this.tutoForm.value["texte"]!=""?this.tutoForm.value["texte"]:texteInput;
      ...
      this.tutoForm.reset();
         ...
         getTuto(){
          ...
          this.apiService.getTuto(id).subscribe(
            ...
            ()=>{
              console.log("You are not authorized to view the content, session expired after 2 hours"),
